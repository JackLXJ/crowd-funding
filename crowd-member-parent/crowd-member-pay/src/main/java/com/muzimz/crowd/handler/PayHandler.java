...
import com.muzimz.crowd.config.PayProperties;
...
public class PayHandler {
    ...
    @ResponseBody
    @RequestMapping(value = "/generate/order", method = RequestMethod.POST)
    public String generateOrder(HttpSession session, OrderVO orderVO) throws AlipayApiException {
        ...
        System.out.println(sendRequestToAliPay(orderNum, orderAmount, orderProjectVO.getProjectName(), orderProjectVO.getReturnContent()));
